            ...
            <div class="box box-info color-palette-box">
                <?php if ($model->status == 0) {?>
                    <div class="box-header">
                        <a href="<?=Yii::$app->urlManager->createUrl(['/admin/notice/act-accept', 'id'=>$model->id]);?>" class="btn btn-success">Подтвердить</a>
                    </div>
                <?php } else {?>
                    <div class="box-header">
                        <a href="<?=Yii::$app->urlManager->createUrl(['/admin/notice/act-decline', 'id'=>$model->id]);?>" class="btn btn-danger">Отменить</a>
                    </div>
                <?php }?>
                <div class="box-body">
