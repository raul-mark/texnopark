...
<div class="content-wrapper">
    ...
    <section class="content">
        <?php if (Yii::$app->session->hasFlash('control_saved')) {?>
            <div class="alert alert-success text-center">
                <?=Yii::$app->session->getFlash('control_saved');?>
            </div>
        <?php }?>
        <?php if ($model) {?>
            <div class="box box-info color-palette-box">
                <div class="box-header">
                    <div class="pull-right">
                        <a href="<?=Yii::$app->urlManager->createUrl(['/admin/notice/control-update', 'id'=>$model->id]);?>" class="btn btn-warning"><i class="fa fa-pencil"></i> Редактировать</a>
                    </div>
