                        ...
                        <div class="box-header">
                            <?php if ($model->status == 0) {?>
                                <div class="pull-right">
                                    <a href="<?=Yii::$app->urlManager->createUrl(['/admin/shipment/confirmation', 'id'=>$model->id, 'type'=>'1']);?>" class="btn btn-success"><i class="fas fa-check"></i> Принять</a>
                                    <a href="<?=Yii::$app->urlManager->createUrl(['/admin/shipment/confirmation', 'id'=>$model->id, 'type'=>'2']);?>" class="btn btn-danger"><i class="fas fa-minus-circle"></i> Отклонить</a>
                                </div>
                            <?php }?>
                            ...
                            <div class="dropdown-menu" x-placement="bottom-start">
                                <a href="<?=Yii::$app->urlManager->createUrl(['/admin/shipment/create']);?>" class="dropdown-item">Добавить списание</a>
                                <a href="<?=Yii::$app->urlManager->createUrl(['/admin/shipment/create', 'id'=>$model->id]);?>" class="dropdown-item">Редактировать</a>
                                <a href="<?=Yii::$app->urlManager->createUrl(['/admin/shipment/remove', 'id'=>$model->id]);?>" class="dropdown-item" class="remove-object">Удалить</a>
                            </div>
                        </div>
                        <div class="box-body">
