        ...
        <div class="card">
            <div class="card-header">
                <div class="pull-right">
                    <a href="<?=Yii::$app->urlManager->createUrl(['/admin/translate/create']);?>" class="btn btn-primary">
                        ...
                        <table class="table table-striped">
                            ...
                            <?php foreach ($words as $k => $v) {?>
                                <tr>
                                    ...
                                    <td><a href="<?=Yii::$app->urlManager->createUrl(['/admin/translate/remove', 'id'=>$v->id]);?>" class="remove-object btn btn-danger"><i class="fas fa-trash"></i> Удалить</a></td>
                                </tr>
                            <?php }?>
                        </table>
                    </div>
