    ...
    <section class="content">
                            ...
                            <div class="col-sm-3">
                                <div class="box box-warning color-palette-box">
                                    ...
                                    <div class="box-footer">
                                        <a href="<?=Yii::$app->urlManager->createUrl(['/worker_shop/shop/stack-view', 'id'=>$id, 'stack_id'=>$stack->id]);?>" class="btn btn-info" style="width:100%">Посмотреть</a>
                                    </div>
                                </div>
                            </div>
                        <?php }?>
        ...
        <div class="box box-info color-palette-box">
            <div class="box-header">
                <div class="box-title">
                    <a href="<?=Yii::$app->urlManager->createUrl(['/worker_shop/shop/stack-create', 'id'=>$id])?>" class="btn btn-primary">
                ...
                <?php Pjax::begin(); ?>
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            //                         <li><a href="'.Yii::$app->urlManager->createUrl(['/worker_shop/shop/stack-view', 'stack_id'=>$model->id]).'" class="dropdown-item">Посмотреть</a></li>
