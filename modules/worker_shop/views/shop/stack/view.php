                        ...
                        <div class="box-header">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-left">
                                    <li><a href="<?=Yii::$app->urlManager->createUrl(['/worker_shop/shop/stack-create']);?>" class="dropdown-item">Добавить этаж</a></li>
                                    <li><a href="<?=Yii::$app->urlManager->createUrl(['/worker_shop/shop/stack-create', 'stack_id'=>$model->id]);?>" class="dropdown-item">Редактировать</a></li>
                                    <li><a href="<?=Yii::$app->urlManager->createUrl(['/worker_shop/shop/stack-remove', 'stack_id'=>$model->id]);?>" class="dropdown-item" class="remove-object">Удалить</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="box-body">
                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'value' => function ($model, $key, $index, $column) {
                                            return '<a href="'.Yii::$app->urlManager->createUrl(['/worker_shop/product/view', 'id'=>$model->product->id]).'">'.$model->product->name_ru.'</a>';
                                        },
                                    ],
                                    [
                                        'attribute'=>'article',
                                            ...
                                            'view' => function ($url, $model) {
                                                return '<div class="btn-group"><button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu pull-right">
                                                            <li><a href="'.Yii::$app->urlManager->createUrl(['/worker_shop/product/view', 'id'=>$model->product->id]).'" class="dropdown-item">Посмотреть</a></li>
                                                            <li><a href="'.Yii::$app->urlManager->createUrl(['/worker_shop/product/remove-shop', 'id'=>$model->product->id]).'" class="dropdown-item" class="remove-object">Удалить</a></li>
                                                        </ul>';
                                            }
                                        ],
                                    ]
