...
class StockController extends Controller{
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            ...
            if ($user->save()) {
                ...
                if ($model->save()) {
                    ...
                    return $this->redirect(['/worker_shop/stock/view', 'id'=>$model->id]);
                }
            }
        }
    ...
    public function actionRemove($id) {
        ...
        return $this->redirect(['/worker_shop/stock']);
    }
    ...
    public function actionStackCreate($id, $stack_id = null) {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            ...
            if ($model->saveObject()) {
                ...
                return $this->redirect(['/worker_shop/stock/stack-view', 'id'=>$model->stock_id, 'stack_id'=>$model->id]);
            }
        }
